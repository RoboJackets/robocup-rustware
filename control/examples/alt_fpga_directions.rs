...
mod app {
    ...
    use main::{
        Delay1, Delay2, Fpga, Imu, SharedSPI, BASE_AMPLIFICATION_LEVEL, CHANNEL, GPT_CLOCK_SOURCE, GPT_DIVIDER, GPT_FREQUENCY, RADIO_ADDRESS
    };
    ...
    struct Local {
        ...
        fpga: FPGA<SharedSPI, Output<P9>, P29, Output<P28>, P30, Delay2, LpspiError, Infallible>,
        imu: Imu,
    ...
    fn init(ctx: init::Context) -> (Shared, Local) {
        ...
        // Initialize the FPGA
        let fpga = match FPGA::new(fpga_spi, cs, init_b, prog_b, done, delay2) {
            Ok(fpga) => fpga,
