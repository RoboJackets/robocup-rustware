...
mod app {
    ...
    use main::{
        Fpga, PitDelay, LedPin, MotorPin, GPT_CLOCK_SOURCE, GPT_DIVIDER, GPT_FREQUENCY
    };
    ...
    #[task(
        shared = [counter, fpga],
        local = [motion_controller, last_encoders, chain_timer, led_pin, motor_pin, initialized: bool = false, iteration: u32 = 0],
        priority = 1
    )]
