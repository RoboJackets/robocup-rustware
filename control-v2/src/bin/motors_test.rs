...
async fn main(spawner: Spawner) {
    ...
    let motor_one_status_channel =
        MOTOR1_STATUS_CHANNEL
            .init(PubSubChannel::<NoopRawMutex, MotorMoveResponse, 4, 1, 1>::new());
    let motor_two_command_channel =
        MOTOR2_COMMAND_CHANNEL.init(PubSubChannel::<NoopRawMutex, MotorCommand, 4, 1, 1>::new());
    let motor_two_status_channel =
        MOTOR2_STATUS_CHANNEL
            .init(PubSubChannel::<NoopRawMutex, MotorMoveResponse, 4, 1, 1>::new());
    let motor_three_command_channel =
        MOTOR3_COMMAND_CHANNEL.init(PubSubChannel::<NoopRawMutex, MotorCommand, 4, 1, 1>::new());
    let motor_three_status_channel =
        MOTOR3_STATUS_CHANNEL
            .init(PubSubChannel::<NoopRawMutex, MotorMoveResponse, 4, 1, 1>::new());
    let motor_four_command_channel =
        MOTOR4_COMMAND_CHANNEL.init(PubSubChannel::<NoopRawMutex, MotorCommand, 4, 1, 1>::new());
    let motor_four_status_channel =
        MOTOR4_STATUS_CHANNEL
            .init(PubSubChannel::<NoopRawMutex, MotorMoveResponse, 4, 1, 1>::new());
